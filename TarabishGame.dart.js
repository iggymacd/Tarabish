...
$$.GameModel = {"":
 ["numberOfPlayers", "players", "deck"],
 "super": "Object",
 createDeck$0: function() {
  var result = $.ListImplementation_List(null);
  for (var t1 = $.iterator($.get$ranks()); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
    for (var t3 = $.iterator($.get$suits()); t3.hasNext$0() === true;)
      result.push($.CardModel$(t2, t3.next$0()));
  }
  return result;
},
 deal$0: function() {
  var deckCopy = $.ListImplementation_List$from(this.deck);
  var t1 = deckCopy.length;
  var t2 = this.numberOfPlayers;
  if (typeof t2 !== 'number')
    throw $.iae(t2);
  var spareCards = $.mod(t1, t2);
  for (; deckCopy.length - spareCards > 0;)
    for (var i = 0; $.ltB(i, $.get$length(this.players)); ++i)
      $.add$1($.index(this.players, i), $.removeLast(deckCopy));
  return this.players;
},
 GameModel$1: function(numberOfPlayers) {
  var t1 = this.numberOfPlayers;
  if (typeof t1 !== 'number')
    return this.GameModel$1$bailout(1, t1);
  this.players = $.ListImplementation_List(t1);
  for (var i = 0; i < t1; ++i)
    $.indexSet(this.players, i, $.ListImplementation_List(null));
  this.deck = $.filter(this.deck, new $.f());
  this.deck = $.shuffle(this.createDeck$0());
},
 GameModel$1$bailout: function(state0, t1) {
  this.players = $.ListImplementation_List(t1);
...
$$.RankModel = {"":
 ["rankValue", "letter?", "nextLower", "nextHigher"],
 "super": "Object",
 RankModel$1: function(rankValue) {
  var t1 = this.rankValue;
  if (t1 < 0 || t1 >= 13)
    throw $.ioore(t1);
  this.letter = 'A23456789TJQK'[t1];
}
};

$$.SuitModel = {"":
 ["suitValue", "letter?", "color", "name?"],
 "super": "Object",
 SuitModel$1: function(suitValue) {
...
$$.CardModel = {"":
 ["id?", "rank?", "suit?"],
 "super": "Object",
 CardModel$2: function(rank, suit) {
  var t1 = $.CardModel_nextId;
  $.CardModel_nextId = $.add(t1, 1);
  this.id = 'id#' + $.S(t1);
}
};

$$.PlayController = {"":
 ["numberOfPlayers", "model", "hands"],
 "super": "Object",
 setupTable$0: function() {
  var rootElement = $.query('#card-table');
  rootElement.set$innerHTML('');
  for (var t1 = $.iterator(this.hands), playerCounter = 1, playerHeading = null, rankSpan = null, cardSpan = null, suitSpan = null, wellDiv = null, handDiv = null; t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
    wellDiv = $.Element_Element$tag('div');
    $.add$1(wellDiv.get$classes(), 'well');
    $.add$1(wellDiv.get$classes(), 'span5');
    playerHeading = $.HeadingElement_HeadingElement$h2();
    var playerCounter0 = playerCounter + 1;
    playerHeading.set$innerHTML('Player ' + $.S(playerCounter));
    wellDiv.insertAdjacentElement$2('beforeend', playerHeading);
    handDiv = $.Element_Element$tag('div');
    $.add$1(handDiv.get$classes(), 'hand');
    for (t2 = $.iterator(t2); t2.hasNext$0() === true;) {
      var t3 = t2.next$0();
      cardSpan = $.Element_Element$tag('span');
      $.add$1(cardSpan.get$classes(), 'card');
      $.add$1(cardSpan.get$classes(), t3.get$suit().get$name());
      rankSpan = $.Element_Element$tag('span');
      $.add$1(rankSpan.get$classes(), 'rank');
      rankSpan.set$innerHTML(t3.get$rank().get$letter());
      suitSpan = $.Element_Element$tag('span');
      $.add$1(suitSpan.get$classes(), 'suit');
      suitSpan.set$innerHTML('&' + $.S(t3.get$suit().get$name()) + ';');
      cardSpan.insertAdjacentElement$2('afterbegin', rankSpan);
      rankSpan.insertAdjacentElement$2('afterend', suitSpan);
      handDiv.insertAdjacentElement$2('beforeend', cardSpan);
    }
    playerHeading.insertAdjacentElement$2('afterend', handDiv);
    rootElement.insertAdjacentElement$2('beforeend', wellDiv);
    playerCounter = playerCounter0;
  }
},
 PlayController$1: function(numberOfPlayers) {
  this.model = $.GameModel$(this.numberOfPlayers);
  this.hands = this.model.deal$0();
}
};
...
$$.f = {"":
 ...
 "super": "Closure",
 call$1: function(e) {
  return !$.eqB(e.get$rank().get$letter(), '6');
}
};
...
$.PlayController$ = function(numberOfPlayers) {
  var t1 = new $.PlayController(numberOfPlayers, null, null);
  t1.PlayController$1(numberOfPlayers);
  return t1;
};
...
$.main = function() {
  $.add$1($.query('#play').get$on().get$click(), $.setupGame);
};
...
$._Elements_createHeadingElement_h2 = function() {
  return $._document().$dom_createElement$1('h2');
};
...
$.RankModel$ = function(rankValue) {
  var t1 = new $.RankModel(rankValue, null, null, null);
  t1.RankModel$1(rankValue);
  return t1;
};
...
$.HeadingElement_HeadingElement$h2 = function() {
  return $._Elements_createHeadingElement_h2();
};

$.GameModel$ = function(numberOfPlayers) {
  var t1 = new $.GameModel(numberOfPlayers, null, null);
  t1.GameModel$1(numberOfPlayers);
  return t1;
};
...
$.CardModel$ = function(rank, suit) {
  var t1 = new $.CardModel(null, rank, suit);
  t1.CardModel$2(rank, suit);
  return t1;
};
...
$.shuffle = function(myArray) {
  ...
  var m = myArray.length - 1;
  var random = $.Random_Random(null);
  for (var t = null, i = null; m > 0;) {
    i = random.nextInt$1(m);
    var t1 = myArray.length;
    if (m >= t1)
      throw $.ioore(m);
    t = myArray[m];
    if (i !== (i | 0))
...
$.SuitModel$ = function(suitValue) {
  var t1 = new $.SuitModel(suitValue, null, null, null);
  t1.SuitModel$1(suitValue);
  return t1;
};
...
$.setupGame = function(event$) {
  $.PlayController$($.int_parse($.query('#choose-players').get$text())).setupTable$0();
};
...
$.shuffle$bailout = function(state0, myArray) {
  var m = $.sub($.get$length(myArray), 1);
  var random = $.Random_Random(null);
  for (var t = null, i = null; $.gtB(m, 0);) {
    i = random.nextInt$1(m);
    t = $.index(myArray, m);
...
$.setupGame.call$1 = $.setupGame;
$.setupGame.$name = "setupGame";
...
$.CTC37 = 'structured clone of ArrayBuffer';
...
Isolate.$lazy($, 'ranks', 'ranks', 'get$ranks', function() {
  return [$.RankModel$(0), $.RankModel$(1), $.RankModel$(2), $.RankModel$(3), $.RankModel$(4), $.RankModel$(5), $.RankModel$(6), $.RankModel$(7), $.RankModel$(8), $.RankModel$(9), $.RankModel$(10), $.RankModel$(11), $.RankModel$(12)];
});
Isolate.$lazy($, 'suits', 'suits', 'get$suits', function() {
  return [$.SuitModel$(0), $.SuitModel$(1), $.SuitModel$(2), $.SuitModel$(3)];
});
var $ = null;
Isolate.$finishClasses($$);
$$ = {};
...
//@ sourceMappingURL=TarabishGame.dart.js.map